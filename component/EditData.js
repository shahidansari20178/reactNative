...
export default class AddStudent extends Component<Props> {
    ...
    constructor(props){
        super(props);
        this.state={
            studentData:this.props.navigation.state.params.edit
        }
    }
    ...
    {
        ///   debugger;
        fetch(`http://localhost:3000/StudentDetails/${this.state.studentData.id}`, {
            method: 'PATCH',
            headers: {
            ...
            body: JSON.stringify({
                ...
                gender: value.gender,
                bdate: this.state.studentData.bdate,
                mobile: value.mobile
    ...
    render() {
        ...
        //alert(JSON.stringify(this.state.studentData))
        return (
            <ScrollView >
